    ...
    <form action="${ctx }${baseMapper }saveMyproduct" method="post" >
    	...
    	<div class="form-group"><div class="input-group">
    		<span class="input-group-addon" >产品名称</span>
  				<input name="name" maxlength="100" class="form-control" placeholder="产品名称" value="${entity.name }"/>
    		</div>
    	</div>
    	<div class="form-group"><div class="input-group">
    		<span class="input-group-addon" >&nbsp;&nbsp;材&nbsp;&nbsp;&nbsp;&nbsp; 质</span>
    	...
    	<div class="form-group"><div class="input-group">
			...
			<textarea name="descript" class="form-control" placeholder="产品特质" >${entity.descript }</textarea>
   		</div></div>
    	<div class="form-group"><div class="input-group">
    	...
    	<div class="form-group"><div class="input-group">
    			<span class="input-group-addon">&nbsp;&nbsp;库&nbsp;&nbsp;&nbsp;&nbsp; 存</span>
  				<input type="number" name="stockNum" class="form-control" placeholder="输入产品库存数量" value="${entity.stockNum }"/>
    		</div>
    	</div>
